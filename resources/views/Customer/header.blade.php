          ...
          <nav class="navbar navbar-expand-lg custom_nav-container ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto">
                  ...
                  <li class="nav-item">
                      <a class="nav-link" href="/customer/pickup">Pickup request</a>
                  </li>
                  <li class="nav-item">
                      <a class="nav-link" href="customer/tracking">Tracking</a>
                  </li>
                  <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="{{url('/customer/login')}}">Login/Sign up</a>
                </li>
