            ...
            <div class="page-content fade-in-up">
                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        ...
                        <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate" action="/admin/branch-store">
                            @csrf

                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">Provience</label>
                                <div class="col-sm-10">
                                <select class="form-control @error('province') is-invalid @enderror" name="province" value="{{ old('province') }}" id="province">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <select class="form-control @error('district') is-invalid @enderror" name="district" value="{{ old('district') }}" id="district">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control  @error('postal_code') is-invalid @enderror" type="text" name="postal_code" value="{{ old('postal_code') }}">
                                    @error('postal_code')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input class="form-control  @error('contact_number') is-invalid @enderror" type="text" name="contact_number" value="{{ old('contact_number')}}">
